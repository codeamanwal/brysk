...
const SellThroughTable = ({ data, columns, sortConfig, handleSort, setPageSize, previousPage, nextPage, canPreviousPage, canNextPage, pageCount, gotoPage, page, getTableProps, getTableBodyProps, headerGroups, prepareRow, pageIndex, pageSize, sortedData }) => {
...
export default SellThroughTable;
