...
import NumberOfBillsTable from "../components/NumberOfBills/NumberOfBillsTable";
import NumberOfBillsChart from "../components/NumberOfBills/NumberOfBillsChart";
      ...
      case "date-range":
        columns = [
          ...
          },
          {
            ...
            accessor: "average_order_value",
            Cell: ({ value }) =>
              value !== null ? parseFloat(value).toFixed(3) : "N/A",
          },
        ];
        break;
      default:
                  ...
                  <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8 pb-2">
                    <div className="inline-block min-w-full py-2 align-middle">
                      ...
                      {loading || (timePeriod === "date-range" && !fetched) ? (
                        ...
                        fetched &&
                        !error && (
                          <NumberOfBillsTable data={filteredData} columns={columns} />
                        )
                      ) : (
                        <NumberOfBillsChart data={filteredData} timePeriod={timePeriod} />
                      )}
                    </div>
                  </div>
                </div>
